...
list_of_files = [
    ...
    "requirements.txt",
    "setup.py",
    "research/trials.ipynb", # for Jupyter Notebook experiments
...
for filepath in list_of_files:
    ...
    if (not os.path.exists(filepath)) or (os.path.getsize(filepath) == 0):
        with open(filepath, "w") as f: #write mode - Opens the file for writing. If the file does not exist, it creates a new empty file. 
            pass
